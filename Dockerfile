...
ENV KEYCLOAK_GATEKEEPER_VERSION=6.0.1 \
...
LABEL "maintainer"="cloudsquad@fxinnovation.com" \
      ...
      "org.label-schema.url"="https://github.com/FXinnovation/fx-docker-keycloak-gatekeeper" \
      "org.label-schema.vcs-url"="https://github.com/FXinnovation/fx-docker-keycloak-gatekeeper" \
